...
export const FigmaIcon: React.FC<IconDefaultProps> = ({ size = 32, color = 'currentColor' }) => {
  return (
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M16 11.75V3.25H20.25C21.3772 3.25 22.4582 3.69777 23.2552 4.4948C24.0522 5.29183 24.5 6.37283 24.5 7.5C24.5 8.62717 24.0522 9.70817 23.2552 10.5052C22.4582 11.3022 21.3772 11.75 20.25 11.75H16Z" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M16 20.25V24.5C16 25.3406 15.7507 26.1623 15.2837 26.8612C14.8168 27.5601 14.153 28.1048 13.3764 28.4265C12.5998 28.7482 11.7453 28.8323 10.9209 28.6683C10.0964 28.5043 9.33917 28.0996 8.7448 27.5052C8.15042 26.9108 7.74565 26.1536 7.58166 25.3291C7.41768 24.5047 7.50184 23.6502 7.82351 22.8736C8.14519 22.097 8.68992 21.4332 9.38883 20.9663C10.0877 20.4993 10.9094 20.25 11.75 20.25H16Z" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
};
