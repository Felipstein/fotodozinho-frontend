...
export const WarnIcon: React.FC<IconDefaultProps> = ({ size = 32, color = 'currentColor' }) => {
  return (
    <svg className='app-icon warn' width={size} height={size} viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
